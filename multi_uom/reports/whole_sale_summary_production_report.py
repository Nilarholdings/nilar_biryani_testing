...
class WholeRetailProductionReport(models.Model):
    _name = 'whole.retail.production.report'
    _description = "Requisition Summary For Production ( Whole Sale + Retail Sale )"
    _auto = False
    ...
    uom_id = fields.Many2one('uom.uom', 'Product UOM', required=False,invisible=True)
    ...
    def _select_sale(self, fields=None):
        ...
        select_ = """
                ...
                wl.create_date as date,
                wl.product_id as product_id,
                wl.product_uom_id as uom_id,
                wl.multi_uom_line_id as multi_uom_line_id,
