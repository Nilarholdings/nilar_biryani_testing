...
class MrpProduction(models.Model):
    ...
    def _onchange_product_id(self):
        ...
        if self.bom_id:
            self.product_multi_uom_qty = self.bom_id.product_qty
        return res
            #etk to solve bom id null error
            # self.compute_multi_uom_line_qty()
            # self.set_multi_uom_line_qty()
    ...
    def _get_move_finished_values_multi_uom(self, product_id, product_uom_qty, product_uom, multi_uom_qty, multi_uom_line_id,
                                  operation_id=False,
        ...
        return {
            ...
            'multi_uom_qty': multi_uom_qty, #etk
    ...
    def _get_moves_finished_values(self):
        ...
        for production in self:
            ...
            moves.append(production._get_move_finished_values_multi_uom(production.product_id.id, production.product_qty,
            ...
            for byproduct in production.bom_id.byproduct_ids:
                ...
                moves.append(production._get_move_finished_values_multi_uom(
                    byproduct.product_id.id, qty, byproduct.product_uom_id.id,
                    multi_uom_qty* self.planned_qty_avg, multi_uom_line_id,
    ...
    def _get_move_raw_values(self, product_id, product_uom_qty, product_uom,
        ...
        data = {
            ...
            'product_uom_qty': product_uom_qty,
            'multi_uom_qty': bom_line.product_multi_uom_qty * self.planned_qty_avg, #etk
