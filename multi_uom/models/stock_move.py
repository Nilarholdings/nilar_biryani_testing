...
class StockMove(models.Model):
    ...
    product_uom_qty = fields.Float(string='QTY', compute='convert_to_product_uom_qty',
                                   inverse='convert_to_multi_uom_qty', store=True, copy=True)
    multi_uom_qty = fields.Float('Demand Qty', digits='Product Unit of Measure', copy=True)
    ...
    difference_qty = fields.Float(string='Difference QTY', compute='_get_difference_qty',
                                  digits='Product Unit of Measure')
    ...
    def _multi_uom_quantity_done_compute(self):
        for rec in self:
            if rec.multi_uom_line_id:
                ...
                rec.multi_quantity_done = rec.quantity_done
    ...
    def _prepare_phantom_move_values(self, bom_line, product_qty, quantity_done):
        ...
        values['multi_uom_line_id'] = bom_line.multi_uom_line_id.id
        return values
