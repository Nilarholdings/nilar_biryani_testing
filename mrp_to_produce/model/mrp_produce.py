...
class MrpProduce(models.Model):
    ...
    default_code = fields.Char('Internal Reference', related='fg_product_id.default_code', store=True)
    product_family_id = fields.Many2one('product.family', related='fg_product_id.product_family_id', store=True)
