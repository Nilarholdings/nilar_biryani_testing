...
class AccountPayment(models.Model):
    ...
    def default_get(self, fields_list):
        ...
        journal_ids = self.env.user.journal_ids.filtered(lambda l: l.type == 'bank' or l.type == 'cash')
        if journal_ids:
    ...
    def onchange_journal(self):
        for rec in self:
            journal_ids = rec.env.user.journal_ids.filtered(lambda l: l.type == 'bank' or l.type == 'cash')
