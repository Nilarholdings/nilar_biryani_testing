...
class ResUser(models.Model):
    ...
    def check_model_access_right(self, model_name):
        ...
        if not self.env.user.control_model_actions: return {'can_create': True, 'can_edit': True, 'can_delete': True}

        model_access_right_lines = self.env.user.model_access_right_lines
