odoo.define('pos_product_filter_by_location.extended_models', function (require) {
    "use strict";

var models = require('point_of_sale.models');
var { Gui } = require('point_of_sale.Gui');
var rpc = require('web.rpc');
models.load_fields('product.product', ['onhand_qty','is_check','detailed_type']);
models.load_models([{
    model:  'stock.quant',
...
models.Order = models.Order.extend({
    add_product: async function(product, options){
        ...
        if (!config.allow_out_of_stock && product.detailed_type === 'product'){
