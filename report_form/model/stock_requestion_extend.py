        ...
        for order in self:
            ...
            for requestion_line in order.stock_requestion_line:
                stock_requestion_line.append({
                    ...
                    'code': requestion_line.product_id.default_code if requestion_line.product_id and requestion_line.product_id.default_code else '',
                    'brand': requestion_line.product_id.brand_id.name or '',
                    'description': requestion_line.product_id.name or '',
                    'uom': requestion_line.multi_uom_line_id.uom_id.name if requestion_line.multi_uom_line_id else '',
                    'req_qty': requestion_line.product_multi_uom_qty or '0',
