...
class PurchaseStockRequisition(models.Model):
    ...
    def get_purchase_stock_requisition_a4(self):
        ...
        for order in self:
            ...
            for line in order.purchase_requisition_line:
                ...
                purchase_requisition_line.append({
                    ...
                    'require_qty': line.multi_required_qty or '0',
                    'allow_qty': line.multi_allowed_qty or '0',
        ...
        return self.env.ref('report_form.action_purchase_stock_requisition_pdf_report').report_action(self, data={
            'records': records})
