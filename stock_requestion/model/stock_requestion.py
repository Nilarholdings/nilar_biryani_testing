...
class StockRequestion(models.Model):
    ...
    request_to = fields.Many2one('stock.location', string='Request To',
    ...
    employee_id = fields.Many2one('hr.employee', 'User Login', default=lambda self: self.env.user.employee_id)
    ...
    def onchange_login_employee(self):
        self.request_from = self.env.user.employee_id.location_id
